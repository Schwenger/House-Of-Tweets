	@politicians = {
		...
		"605": {
			"citizen_bird": "kleiber",
			"cv": {
				"de": "Gabriele \u201eGabi\u201c Weber (* 24. M\u00e4rz 1955 in Ebernhahn bei Montabaur, Rheinland-Pfalz) ist eine deutsche Politikerin (SPD) und Abgeordnete des Deutschen Bundestages.",
		...
		"62": {
			"citizen_bird": "gimpel",
			"cv": {
				"de": "Agnieszka Brugger geb. Malczak (auch Agnes Brugger; * 8. Februar 1985 in Legnica, Polen) ist eine deutsche Politikerin (B\u00fcndnis 90/Die Gr\u00fcnen) polnischer Herkunft.",
		...
		"629": {
			"citizen_bird": "feldsperling",
			"cv": {
				"de": "Dagmar Gabriele W\u00f6hrl (geb. Winkler; * 5. Mai 1954 in Stein bei N\u00fcrnberg) ist eine deutsche Politikerin (CSU), ehemalige Miss Germany und fr\u00fchere parlamentarische Staatssekret\u00e4rin beim Bundesminister f\u00fcr Wirtschaft und Technologie. Sie ist verheiratet mit Hans Rudolf W\u00f6hrl.",
		...
		"642": {
			"citizen_bird": "haussperling",
			"cv": {
				"de": "Jens Zimmermann (* 9. September 1981 in Gro\u00df-Umstadt) ist ein deutscher Politiker (SPD). Er ist seit 2013 Mitglied des Deutschen Bundestages.",
		...
		"67": {
			"citizen_bird": "gartengrasmuecke",
			"cv": {
				"de": "Marco B\u00fclow (* 14. Juni 1971 in Dortmund) ist ein deutscher Politiker (SPD). Seit 2002 geh\u00f6rt er als direkt gew\u00e4hlter Abgeordneter im Bundestagswahlkreis Dortmund I dem Deutschen Bundestag an. Seine politischen Schwerpunkte sind Transparenz und Lobbyismus sowie Bau- und Umweltpolitik.",
